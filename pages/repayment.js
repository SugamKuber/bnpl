...
const Repayment = () => {
  const { connectWallet, connected, repayments, disconnect, contract, provider, seaport, modal, setModal, setUrl, url } = useContext(solpayContext);
